...
This version is ideal for players who want a lightweight, mobile-friendly arcade challenge that still rewards precision and focus. It works on desktop with a mouse click or spacebar too, so it is a good skill trainer for anyone who likes tap-to-fly, physics-based browser games, and small competitive challenges.""",
  ...
  },
  {
    ...
    "fullGameUrl": MyImages.rocketFull,
    "halfGameUrl": MyImages.rocketHalf,
    "imageUrl": "https://hexgl.bkcore.com/img/logo.png",
    "description":
        "Pilot a fast anti-gravity hover racer in your browser; glide through sci-fi tracks, hit boosts, and chase perfect lap times.",
    "longDescription":
        """HexGL is a fast, skill-first anti-gravity racing game you can play instantly in your browser. Built with WebGL, it borrows the clean, futuristic feel of classic hover racers but strips things down to pure driving. You guide a sleek craft along broad sci-fi circuits, reading the banking and camber, easing into corners, then punching boost as you exit to carry speed onto the straight. The physics are light but consistent, so good lines always beat wild steering. Because the build is lightweight, it runs well on most desktops and laptops, making it perfect for quick time-trial sessions or a few warm-up laps between tasks. There are no random power-ups to bail you out — progress comes from memorizing turns, braking early, and staying off the walls. If you enjoy browser racing games that reward precision, HexGL gives you a focused run at high speed. It’s also a useful demo for WebGL performance in HTML5 games, showing how much motion and polish you can deliver without plugins or installs.""",
    "about":
        "HexGL is a community-built browser racing project that recreates wipeout-style anti-gravity speed in WebGL. It’s an independent fan effort, made to show what modern HTML5 / browser racing games can do, and it isn’t connected to or endorsed by any official franchise.",
    "aboutThisGame": {
      "genre": "Skill-based WebGL anti-gravity racing (browser)",
      "sessionLength": "1–5 minute laps and retries — ideal for time trials or warm-ups.",
      "coreSkills": [
        "Reading track banking and camber before turns",
        "Maintaining clean racing lines at high speed",
        "Boost timing on exits and long straights"
      ],
      "bestFor": [
        "Players who enjoy precision, not random power-ups",
        "Keyboard racers who like responsive controls",
        "Fans of futuristic, hovercraft-style track design"
      ],
      "monetization":
          "Browser version is free to play and has no in-race pay gates or forced upgrades."
    },
    "features": [
      "Responsive hover physics tuned for keyboard play — quick taps, no sluggish steering.",
      "Readable, futuristic circuits with wide corners, banked sections, and room to plan your line.",
      "Boost system that rewards stable exits, not button mashing in the middle of a turn.",
      "Runs in modern browsers, so you can jump into a sci-fi racer without downloads or installs."
    ],
    "howToPlayQuick": {
      "desktop":
          "Use Arrow keys or WASD to steer, accelerate, and brake. Press Shift / Control (or the mapped key) to boost once the craft is pointing straight.",
      "mobile":
          "Best played on desktop or laptop. Some devices work with external keyboards or controllers for smoother handling.",
      "goal":
          "Lap the track as fast as possible by keeping speed through corners and avoiding wall scrapes that kill momentum."
    },
    "proTips": [
      "Brake in a straight line before the corner, then release and let the hovercraft float through the arc.",
      "Look a corner ahead and make micro-steering nudges — tiny inputs keep you centered and fast.",
      "Use boost only when the craft is stable and facing down a straight so you don’t waste speed on corrections."
    ],
    "whyPeopleLoveIt": [
      "Delivers classic browser hover-racing feel in seconds, no installer or launcher needed.",
      "Speed is something you earn by learning the track, not by picking up random items.",
      "Short sessions still feel intense, making it great for quick leaderboard or lap-time runs."
    ],
    "howToPlay": [
      "Run the track slowly once to memorize banking, camber, and tricky chicanes.",
      "Tap brakes before you turn, not during, so the hovercraft doesn’t skid wide.",
      "Hit boost right after a corner exit or on a long straight to lock in a faster lap.",
      "Repeat the same circuit to smooth out your line, reduce wall hits, and push for consistent times."
    ],
    "tags": [
      "racing",
      "webgl",
